...
import com.andy.cali.activity.LogDietsfirstActivity.ListViewItem;

public class CustomAdapterLogFirst extends BaseAdapter {
	

		LayoutInflater inflater;
		List<ListViewItem> items;

		public CustomAdapterLogFirst(Activity context, List<ListViewItem> items) {
			super();
