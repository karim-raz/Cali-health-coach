...
import com.andy.cali.activity.FinalizeLogActivity.ListViewItem;


public class CustomAdapterFinalize extends BaseAdapter {
	

		LayoutInflater inflater;
		List<ListViewItem> items;

		public CustomAdapterFinalize(Context context, List<ListViewItem> items) {
			super();
