...
public class WeekStepsDetailsFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		root = inflater.inflate(R.layout.weeksteps_layout, container, false);
		...
		iv = (ImageView) root.findViewById(R.id.Mypic1d);
		...
		My = (TextView) root.findViewById(R.id.todayd);
		My.setText(l.get(0).getName().toString());
		share = (ButtonFloat) root.findViewById(R.id.buttonFloat22d);
		final RippleBackground rippleBackground = (RippleBackground) root
				.findViewById(R.id.contentd);
		...
		share.setOnClickListener(new OnClickListener() {
			...
			//	Intent sharingIntent = new Intent(Intent.ACTION_SEND);
				...
				String sharingText = getString(R.string.stepsd1) + " "
						+ mStepValue + " " + getString(R.string.stepsd7);
...
//						.createChooser(sharingIntent, "Share using"));
	...
	public void onResume() {
		...
		mStepValueView = (TextView) root.findViewById(R.id.stepsvalued);
		mCaloriesValueView = (TextView) root.findViewById(R.id.textView2261d);
